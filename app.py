...
# title and layout
st.set_page_config(page_title="SmartMargin PH - E-Com Intelligence", page_icon="⚡")

st.title("⚡ SmartMargin PH")
st.subheader("Instant Profit & Marketplace Fee Calculator for PH Sellers")
st.write("Stop guessing your net profits after Shopee, Lazada, and TikTok Shop cuts!")
...
# Output Display
st.markdown(f"### 📊 Net Profit Breakdown for: **{item_name}**")
